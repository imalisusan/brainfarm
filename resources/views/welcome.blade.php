    ...
    <body class="antialiased" style="background-color: transparent;">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                   ...
                   <h1 class="font-semibold text-xl text-gray-800 leading-tight" style="border-bottom: 0px;"> Brainfarm</h1>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <img src="{{ asset('images\weather.svg') }}" class="block h-9 w-auto" />
