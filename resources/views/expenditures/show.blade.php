<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Expenditure Details') }}&nbsp;&nbsp;
          
            <form class="inline" action="{{  route('expenditures.destroy', $expenditure->id) }}" method="POST">                        
                <a href="{{ route('expenditures.edit', $expenditure->id)  }}" class="border-gray-300 text-left  leading-4 text-blue-500 tracking-wider">Edit</a>&nbsp;
                    @csrf
                    @method('DELETE')
