<div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
    <div class="-mx-3 md:flex mb-6">
        ...
        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            <x-label for="farmer name*" class="block uppercase text-xs font-bold mb-2" />
            ...
            rounded py-3
            px-4 mb-3" value="{{isset($farmer) ? $farmer->name : old('name') }}">
        ...
        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            rounded py-3
            px-4 mb-3" value="{{isset($farmer) ? $farmer->email : old('email') }}">
            <x-error field="name" class="text-red-600" />
        </div>
    </div>
    ...
    <div class="-mx-3 md:flex mb-6">
        ...
        <div class="md:w-1/2 px-3">
            <x-label for="phone*" class="block uppercase text-xs font-bold mb-2" />
                ...
                value="{{ isset($farmer) ? $farmer->phone :old('phone') }}" style="border:1px solid rgb(104, 104, 104);">
        ...
        <div class="md:w-1/2 px-3">
            <x-label for="address*" class="block uppercase text-xs font-bold mb-2" />
                ...
                rounded py-3 px-4 mb-3" 
                value="{{ isset($farmer) ? $farmer->address :old('address') }}" style="border:1px solid rgb(104, 104, 104);">
        ...
        duration-300 hover:bg-blue-700 hover:text-white focus:outline-none place-self-center">Save Farmer</button>
    </div>
</div>