<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <form class="inline" action="{{  route('farmers.destroy', $farmer->id) }}" method="POST">                        
                <a href="{{ route('farmers.edit', $farmer->id)  }}" class="border-gray-300 text-left  leading-4 text-blue-500 tracking-wider">Edit</a>&nbsp;
                    @csrf
                    @method('DELETE')
                        ...
                        <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                            ...
                            <div class="flex  mb-10 lg:items-start items-center">
                                <div class="flex-grow">
                                    ...
                                    <p class="leading-relaxed text-base">{{ $farmer->name }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex  mb-10 lg:items-start items-center">
                                <div class="flex-grow">
                                    ...
                                    <p class="leading-relaxed text-base">{{ $farmer->created_at->calendar() }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                            ...
                            <div class="flex  mb-10 lg:items-start items-center">
                                <div class="flex-grow">
                                    ...
                                    <p class="leading-relaxed text-base">{{ $farmer->address }}
                                    </p>
                                </div>
                            </div>
