    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 ">
                <div
                    class="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden shadow-lg px-12 ">
                    <div class="flex justify-between">
                        <a type="button" href="{{ route('farmercrops.create') }}"
                ...
                <div
                    ...
                    <body>
                        @livewire('farmer-crops-table-view')
                    </body>
